...
class ItemRequestServiceImplTest {
    ...
    void createItemRequest() {
        ...
        MatcherAssert.assertThat(itemRequest.getId(), equalTo(itemRequestDto.getId()));
        MatcherAssert.assertThat(itemRequest.getRequestor().getId(), equalTo(userDto2.getId()));
    ...
    void getAllItemRequestsExceptByUser() {
        ...
        MatcherAssert.assertThat(itemRequest.get(0).getId(), equalTo(itemRequestsDto.get(0).getId()));
        MatcherAssert.assertThat(itemRequest.get(0).getDescription(), equalTo(itemRequestsDto.get(0).getDescription()));
