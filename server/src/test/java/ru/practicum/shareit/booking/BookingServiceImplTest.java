...
class BookingServiceImplTest {
    ...
    void createBooking() {
        ...
        MatcherAssert.assertThat(booking.getId(), equalTo(bookingDtoResponse.getId()));
        MatcherAssert.assertThat(booking.getStatus(), equalTo(bookingDtoResponse.getStatus()));
    }
    ...
    void getAllUserBooking_stateAll() {
        ...
        MatcherAssert.assertThat(booking.get(0).getId(), equalTo(bookingDtoResponse.get(0).getId()));
        MatcherAssert.assertThat(booking.get(0).getStatus(), equalTo(bookingDtoResponse.get(0).getStatus()));
