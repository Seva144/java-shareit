...
class ItemServiceImplTest {
    ...
    void createItem() {
        ...
        MatcherAssert.assertThat(item.getId(), notNullValue());
        MatcherAssert.assertThat(item.getId(), equalTo(itemDto.getId()));
        MatcherAssert.assertThat(item.getName(), equalTo(itemDto.getName()));
        MatcherAssert.assertThat(item.getDescription(), equalTo(itemDto.getDescription()));
        MatcherAssert.assertThat(item.isAvailable(), equalTo(itemDto.getAvailable()));
        MatcherAssert.assertThat(item.getOwner(), equalTo(userDto1.getId()));
    ...
    void patchItem() {
        ...
        MatcherAssert.assertThat(item.getId(), notNullValue());
        MatcherAssert.assertThat(item.getId(), equalTo(itemDto.getId()));
        MatcherAssert.assertThat(item.getName(), equalTo(itemDtoUpdate.getName()));
        MatcherAssert.assertThat(item.getDescription(), equalTo(itemDtoUpdate.getDescription()));
        MatcherAssert.assertThat(item.isAvailable(), equalTo(itemDtoUpdate.getAvailable()));
        MatcherAssert.assertThat(item.getOwner(), equalTo(userDto1.getId()));
    }
    ...
    void getItemByUserId() {
        ...
        MatcherAssert.assertThat(itemDto.get(0).getId(), equalTo(items.get(0).getId()));
        MatcherAssert.assertThat(itemDto.get(0).getDescription(), equalTo(items.get(0).getDescription()));
        MatcherAssert.assertThat(itemDto.get(0).getName(), equalTo(items.get(0).getName()));
        MatcherAssert.assertThat(itemDto.get(0).getAvailable(), equalTo(items.get(0).getAvailable()));
        MatcherAssert.assertThat(itemDto.get(0).getRequestId(), equalTo(items.get(0).getRequestId()));
    ...
    void searchItemsByText_returnEmpty() {
        ...
        MatcherAssert.assertThat(items, Matchers.is(empty()));
    }
    ...
    void createComment() {
        ...
        MatcherAssert.assertThat(commentDto.getId(), equalTo(commentResponse.getId()));
        MatcherAssert.assertThat(commentDto.getText(), equalTo(commentResponse.getText()));
        MatcherAssert.assertThat(commentDto.getAuthorName(), equalTo(commentResponse.getAuthorName()));
    }
    ...
    void getCommentsByItemId() {
        ...
        MatcherAssert.assertThat(commentsDto.get(0).getId(), equalTo(commentResponse.get(0).getId()));
        MatcherAssert.assertThat(commentsDto.get(0).getText(), equalTo(commentResponse.get(0).getText()));
        MatcherAssert.assertThat(commentsDto.get(0).getAuthorName(), equalTo(commentResponse.get(0).getAuthorName()));
