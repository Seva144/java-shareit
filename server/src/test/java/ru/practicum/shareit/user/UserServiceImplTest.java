...
class UserServiceImplTest {
    ...
    void createUser() {
        ...
        MatcherAssert.assertThat(user1.getId(), notNullValue());
    ...
    void patchUser() {
        ...
        MatcherAssert.assertThat(user1.getId(), notNullValue());
        MatcherAssert.assertThat(user1.getName(), equalTo(userDtoUpdate.getName()));
        MatcherAssert.assertThat(user1.getEmail(), equalTo(userDtoUpdate.getEmail()));
