...
public class ItemClient extends BaseClient {
    ...
    public ResponseEntity<Object> createItem(ItemDto item, Long owner) {
        return post("", owner, item);
    }

    public ResponseEntity<Object> patchItem(Long idItem, ItemDto itemDto, Long owner) {
        return patch("/" + idItem, owner, itemDto);
    }

    public ResponseEntity<Object> getItem(Long idItem, Long owner) {
        return get("/" + idItem, owner);
    }
